...
public final class ImmutableOrdinalMap implements OrdinalMap {
    ...
    public static OrdinalMap build(Object owner, TermsEnum subs[], long[] weights, float acceptableOverheadRatio) throws IOException {
      ...
      return new ImmutableOrdinalMap(owner, subs, segmentMap, acceptableOverheadRatio);
    }
    ...
    ImmutableOrdinalMap(Object owner, TermsEnum subs[], SegmentMap segmentMap, float acceptableOverheadRatio) throws IOException {
